...
```{r}
# Set this to `FALSE`, if you want to load the agent-level data (not provided here).
LOAD_AGGR_DATA = TRUE
```
...
```{r}
# Important:
# If you want to load the provided aggregated data, just uncomment the corresponding definition of `sens_param_name`.
# If you want to load the agent-level data (not provided here), also uncomment the line where the corresponding `df`is defined.
